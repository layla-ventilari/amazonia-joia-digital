      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="font-playfair text-4xl md:text-5xl lg:text-6xl text-green-forest mb-6 animate-fade-in">
            Arte viva da floresta. Raízes ancestrais, alma nômade.
          </h1>
          
          <p className="text-xl md:text-2xl text-earth/80 mb-8 animate-fade-in" style={{ animationDelay: '0.2s' }}>
            Cada peça é um portal. Criada com materiais ecológicos da Amazônia, tingida com saberes ancestrais e moldada por mãos que carregam histórias.
          </p>
